export default function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: "Verkoop de producten aan klanten en behoud het volledige verschil als winst.",
    },
  ];

  return (
    <section id="hoe-werkt-het" className="px-4 sm:px-6 py-16 sm:py-24 bg-white">
